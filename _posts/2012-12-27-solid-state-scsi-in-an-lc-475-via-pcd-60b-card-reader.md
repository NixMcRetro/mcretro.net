...
The Macintosh LC 475. Now with solid state components for the hard drive. Reliable, check. Dependable, check. Awesome, heck yes! Inspired by a forum post over at the [68K Mac Liberation Army](https://68kmla.org/bb/index.php?threads/se-30-booting-off-cf-success.24191/) I decided to make my LC 475 silent(er). The LC 475 is a solid machine and I love to talk about it. With the old SCSI hard drive removed, it is much quieter although the fan needs a resistor on it to make it just that little more silenter.
