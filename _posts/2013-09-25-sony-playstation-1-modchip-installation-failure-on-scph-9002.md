...
As with the previous video, without the modchip, we weren't going to get too far anyway even if all the wires had gone in properly. I've since purchased a pair of wire strippers - How did I not have these before now? and some nice PIC flash chips so I can make mistakes and reflash - that's the power of EEPROM!