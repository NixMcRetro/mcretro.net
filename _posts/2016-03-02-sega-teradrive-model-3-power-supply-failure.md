...
![Sega TeraDrive Model 3 PSU](/assets/images/2016/img_0457.jpg)
...
Anyway, here are some useful links to helpful software: - [Amstrad Mega PC dd image](/files) - [HDD Raw Copy Tool](http://hddguru.com/software/HDD-Raw-Copy-Tool/) for an easy way to duplicate CF cards for the XTIDE or XT-CF-Lite ISA cards. - [XTIDECFG (r588)](/files) - XTIDE [ide_xt r588](/files) that has been compiled to play nice with CF cards, show the attractive boot menu and... well works on TeraDrives and Amstrad Mega PCs. Probably works on a lot more. Good for the XT-CF-Lite 4.1 card.
