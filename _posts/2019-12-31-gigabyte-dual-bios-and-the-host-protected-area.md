...
Gigabyte motherboards with an Xpress Recovery BIOS are apparently affected by a bug! The following is taken from [here](https://web.archive.org/web/20181216211558/http://www.users.on.net/~fzabkar/HDD/HDD_Capacity_FAQ.html).
