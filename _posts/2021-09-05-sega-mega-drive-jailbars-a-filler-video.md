...
**Update 2021-12-05** Docker has been updated and I've swapped to images that are based off Bullseye (Debian 11) which fixes the crashing under ARM native images. No more SIGSEGVs for me. I am also glad to noted that Docker gives the option to install updates again rather than forcing them on non-businesses. Thank you Docker!
